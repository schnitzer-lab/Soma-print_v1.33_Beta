...
refreshAll();
    ...
    function buildSomaprintPage()
        ...
        paramRoot.RowHeight = {90, 36, 96, '1x'};
        ...
        basicGrid.ColumnWidth = {82, '1x', 82, '1x'};
        basicGrid.RowHeight = {28, 28};
        basicGrid.RowSpacing = 4;
        basicGrid.Padding = [6 6 6 6];
        ...
        advancedRows = ceil(numel(advancedFields) / 3);
        advancedGrid = uigridlayout(advancedPanel, [advancedRows + 1, 6]);
        advancedGrid.ColumnWidth = {78, '1x', 78, '1x', 78, '1x'};
        advancedGrid.RowHeight = [{30}, repmat({26}, 1, advancedRows)];
        advancedGrid.RowSpacing = 4;
        advancedGrid.Padding = [6 6 6 6];
        advancedNote = uilabel(advancedGrid, ...
            'Text', 'Most users can leave these at their defaults.', ...
            'WordWrap', 'on');
        advancedNote.Layout.Row = 1;
        advancedNote.Layout.Column = [1 6];
        advancedNote.FontSize = 10;
