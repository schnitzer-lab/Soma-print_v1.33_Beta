function [data_score_somaprintwd,data_score_somaprint]=ComputeSomaprint(map1,map2,n_vec,p_sum,sigma,n_vec2)
...
Somaprint_LogMessage(['- Number of vectors:',num2str(round(n_vec*p_sum)), ' out of ', num2str(n_vec)]);
